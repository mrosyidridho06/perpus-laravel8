...
<nav class="bg-white px-8 pt-2 shadow-md">
     <div class="-mb-px flex justify-center">
         ...
         <a class="no-underline text-grey-dark border-b-2 border-transparent uppercase tracking-wide font-bold text-xs py-3 mr-8" href="/buku">
             Buku
         </a>
...
<!-- ? -->
  @yield('content')
  <footer class="footer bg-gray-300 pt-8 pb-6">
